<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsS5.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', ' R18.60')">Stored Value: R18.60</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', '  R158.80')">14 Trip Weekly:  R158.80</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', ' R681.10')">44 Trip Monthly:  R681.10</button>
