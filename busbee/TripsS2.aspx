<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsS2.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', '  R11.10')">Stored Value: R11.10</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', ' R93.90')">14 Trip Weekly: R93.90</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', 'R354.10')">44 Trip Monthly: R354.10</button>
    <button class="block-button" onclick="showConfirmation('52 Trip Monthly', 'R1220.70')">52 Trip Monthly: R1220.70</button>
