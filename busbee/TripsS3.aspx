<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsS3.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', '  R13.70')">Stored Value:  R13.70</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', ' R109.50')">14 Trip Weekly: R109.50</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', ' R481.20')">44 Trip Monthly: R481.20</button>
    <button class="block-button" onclick="showConfirmation('52 Trip Monthly', ' R1421.90')">52 Trip Monthly:  R1421.90</button>
