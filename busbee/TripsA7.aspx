<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsA7.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', ' R31.40')">Stored Value: R31.40</button>
    <button class="block-button" onclick="showConfirmation('10 Trip Weekly', 'R259.00')">10 Trip Weekly: R259.00</button>
    <button class="block-button" onclick="showConfirmation('12 Trip Weekly', 'R310.90')">12 Trip Weekly: R310.90</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', 'R362.60')">14 Trip Weekly:R362.60</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', 'R1 139.50')">44 Trip Monthly: R1 139.50</button>
    <button class="block-button" onclick="showConfirmation('52 Trip Monthly', 'R1 346.70')">52 Trip Monthly: R1 346.70</button>
