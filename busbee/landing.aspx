...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo"><img src="assets/img/busbeelogo.png" alt="" class="img-fluid"></a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 bus-img">
          <img src="assets/img/bus.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="footer-top">
      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-6">
            <h3>BusBee</h3>
            <p>Subscribe for updates to our web application</p>
          </div>
        </div>
