<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsD8.aspx.cs" Inherits="busbee.purchasebusticket" %>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="inner">
        ...
        <p>Select your prices:</p>
         ...
         <a href="StoredValue.aspx" class="block-button">Stored Value:  R22.20</a>
         </div>
          
        <h2>Prices </h2>
        <p>Select your prices:</p>
    <!-- Buttons with event listeners -->
    <button class="block-button" onclick="showConfirmation('Stored Value', '  R22.20')">Stored Value: R22.20</button>
