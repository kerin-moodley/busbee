<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsA8.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', '  R34.20')">Stored Value:  R34.20</button>
    <button class="block-button" onclick="showConfirmation('10 Trip Weekly', 'R278.60')">10 Trip Weekly: R278.60</button>
    <button class="block-button" onclick="showConfirmation('12 Trip Weekly', 'R334.30')">12 Trip Weekly: R334.30</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', ' R389.90')">14 Trip Weekly: R389.90</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', 'R1 225.70')">44 Trip Monthly:R1 225.70</button>
    <button class="block-button" onclick="showConfirmation('52 Trip Monthly', 'R1 448.60')">52 Trip Monthly: R1 448.60</button>
