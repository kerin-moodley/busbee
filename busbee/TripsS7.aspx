<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsS7.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', '   R21.80')">Stored Value: R21.80</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', '  R181.60')">14 Trip Weekly: R181.60</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', 'R799.00')">44 Trip Monthly:R799.00</button>
