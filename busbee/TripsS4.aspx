<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsS4.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', '   R16.50')">Stored Value:  R16.50</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', ' R135.10')">14 Trip Weekly: R135.10</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', ' R594.80')">44 Trip Monthly:   R594.80</button>
    <button class="block-button" onclick="showConfirmation('52 Trip Monthly', ' R1872.00')">52 Trip Monthly: R1872.00</button>
