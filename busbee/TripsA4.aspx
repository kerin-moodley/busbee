<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsA4.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', ' R23.8')">Stored Value: R23.80</button>
    <button class="block-button" onclick="showConfirmation('10 Trip Weekly', 'R189.900')">10 Trip Weekly: R189.90</button>
    <button class="block-button" onclick="showConfirmation('12 Trip Weekly', 'R229.10')">12 Trip Weekly: R229.10</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', 'R265.80')">14 Trip Weekly: R265.80</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', 'R835.50')">44 Trip Monthly: R835.50</button>
    <button class="block-button" onclick="showConfirmation('52 Trip Monthly', ' R987.10')">52 Trip Monthly: R987.10</button>
