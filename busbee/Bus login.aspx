<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bus login.aspx.cs" Inherits="busbee.Bus_login" %>
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form id="frmLogin" runat="server">
                  ...
                  <div class="pt-1 mb-4">
                    ...
                    <cc1:RecaptchaWidget ID="Recaptchalogin" runat="server" />
                    <br />
                    <asp:Button type="button" ID="btnLogin" class="btn btn-outline-success btn-lg" runat="server" Text="Login" Width="400px" OnClick="btnLogin_Click" />
                  </div>
