...
.grid-item.top {
  grid-row: 1; /* Place top items in the first row */
}

/* Styles for the bottom grid items */
.grid-item.bottom {
  grid-row: 2; /* Place bottom items in the second row */
}
        .grid-image {
            width: 45%;
            cursor: pointer;
...
<div class="grid-container">
    <div class="grid-item top">
      <img src="Images/Profile.png" alt="Image 1" class="grid-image"onclick="openPopup(1)">
    
    </div>
   <div class="grid-item top">
      <img src="Images/B4today.png" alt="Image 2" class="grid-image" onclick="openPopup(2)">
    </div>
     <div class="grid-item bottom">
      <img src="Images/location1.png" alt="Image 3" class="grid-image" onclick="openPopup(3)">
    </div>
      <div class="grid-item bottom">
      <img src="Images/contact.png" alt="Image 4" class="grid-image" onclick="openPopup(4)">
    </div>
  </div>
  <main id="main">

        <!-- Popup container -->
    <div id="popup-container-1" class="popup">
        <!-- Popup content -->
...
<section id="about" class="about">
 ...
 <div id="popup-container-2" class="popup">
        <!-- Popup content -->
        <div class="popup-content">
            <span class="close" onclick="closePopup()">&times;</span>
...
<div class="route-column">
    <ul>
      ...
      <div id="popup-container-3" class="popup">
        <!-- Popup content -->
        <div class="popup-content">
            <span class="close" onclick="closePopup()">&times;</span>
    <!-- ======= Location Section ======= -->
...
<asp:Button ID="stopAutoUpdate" runat="server" Text="Stop Automatic Update" BackColor="#1A9082" BorderStyle="None" ForeColor="White" Height="39px" Width="250px" />
      ...
      <div id="popup-container-4" class="popup">
        <!-- Popup content -->
        <div class="popup-content">
            <span class="close" onclick="closePopup()">&times;</span>
    <!-- ======= Contact Section ======= -->
            ...
            <div class="info-container d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="row">
                  ...
                  <div class='col-md-6 form-group mt-3 mt-md-0'>
                      <asp:TextBox ID="txtEmail" TextMode="Email" class="form-control" placeholder="Your Email" style="background-color: #e0ebeb; color: #222831; border: none; box-shadow: 2px 2px 5px lightgrey; margin-left: 15px;" runat="server" Height="48px" Width="678px"></asp:TextBox>
                      &nbsp;
                      &nbsp; 
                      <asp:TextBox ID="txtSubject" class="form-control" placeholder="Subject" style="background-color: #e0ebeb; color: #222831; border: none; box-shadow: 2px 2px 5px lightgrey; margin-left: 15px;" runat="server" Height="48px" Width="678px"></asp:TextBox>
                      &nbsp;
                      &nbsp;         
  ...
  <script src="assets/js/main.js"></script>
    <!--Pop Container-->
     <script>
         // Function to open the popup with the specified image number
         function openPopup(popupNumber) {
             const popup = document.getElementById("popup-container-" + popupNumber);
