<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsA6.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', ' R29.00')">Stored Value: R29.00</button>
    <button class="block-button" onclick="showConfirmation('10 Trip Weekly', 'R236.20')">10 Trip Weekly: R236.20</button>
    <button class="block-button" onclick="showConfirmation('12 Trip Weekly', 'R284.80')">12 Trip Weekly: R284.80</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', 'R332.20')">14 Trip Weekly: R332.20</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', 'R1 044.10')">44 Trip Monthly: R1 044.10</button>
    <button class="block-button" onclick="showConfirmation('52 Trip Monthly', ' R1234.00')">52 Trip Monthly:R1234.00</button>
