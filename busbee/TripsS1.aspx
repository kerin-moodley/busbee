<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripsS1.aspx.cs" Inherits="busbee.purchasebusticket" %>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <button class="block-button" onclick="showConfirmation('Stored Value', '  R9.90')">Stored Value: R9.90</button>
    <button class="block-button" onclick="showConfirmation('14 Trip Weekly', ' R80.50')">14 Trip Weekly: R80.50</button>
    <button class="block-button" onclick="showConfirmation('44 Trip Monthly)', 'R354.10')">44 Trip Monthly: R354.10</button>
    <button class="block-button" onclick="showConfirmation('52 Trip Monthly', 'R1046.30')">52 Trip Monthly: R1 448.60</button>
